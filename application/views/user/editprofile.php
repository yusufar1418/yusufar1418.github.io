...
<div class="container-fluid">
  ...
  <h1 class="h3 mb-4 text-gray-800"><?= $title; ?></h1>
		    ...
		    <div class="col-sm-10">
		      <input type="text" class="form-control" id="name" placeholder="name" name="name" value="<?= $user['username']; ?>">
		    ...
		    <div class="col-sm-10">
		    	<div class="row">
		    		<div class="col-sm-3">
		    			<img src="<?= base_url('assets/img/user/') . $user['image'] ?>" class="img-thumbnail">
		    		</div>
		    		<div class="col-sm-9">
